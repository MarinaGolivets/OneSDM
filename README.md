OneSDM: Automated Workflows for Invasive Alien Species Distribution
Modelling
================

## Overview

As part of the One Biosecurity approach for terrestrial invasive alien
species implemented in the OneSTOP project, OneSDM provides
functionality for automated species distribution modelling. The entire
SDM workflow can be run with minimal input from the user using default
settings, while also offering full flexibility for more experienced
users. The package includes fine-grained functions to download and
prepare input data, model species distributions, and post-process model
predictions, as well as wrapper functions that allow an entire workflow
to be executed with just a few lines of code.
...
- **Contact us** directly at `elgabbas[at]outlook[dot]com` or
  `maryna.golivets[at]ufz[dot]de` for collaboration ideas or questions.
